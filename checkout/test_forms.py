...
class DesktopCartFeaturesIssuesTest(unittest.TestCase):
    ...
    def test_features_cart_checkout_purchase(self):
        ...
        text_list = "Success! We've charged your card!"
    ...
    def test_features_cart_checkout_failed_purchase(self):
        ...
        self.driver.find_element_by_id(
            'creditcard-number').send_keys('6242 4242 4242 4242')
        self.driver.implicitly_wait(0)  # seconds
        ...
        warnings_list = 'Your card number is incorrect.'
